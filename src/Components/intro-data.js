      ...
      <div className="IntroData">
        <div className="IntroHeader">
          ...
          <section>
            ...
            <p>
              Chore Wars helps you organize you housework in a fun and easy way.
              Create personalized chore lists, randomly assign chores to
          ...
          <section>
            ...
            <p>
              ...
              rewards that housemates can vote on to incentivize progress- pizza
              parties for the people! PLUS - in-game awards grant access to
              perks like the "Swap-a-Chore" and extra votes for the IRL rewards.
            </p>
          </section>
          <section>
            <header>
        ...
        <Link to="/chore-list">Check out the demo</Link>
      </div>
    );
  }
}
